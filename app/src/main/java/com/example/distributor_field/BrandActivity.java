...
public class BrandActivity extends AppCompatActivity {
    ...
    BrandAdapter categoryListAdapter;

    String brandName;
    ArrayList<Brand> brandDetails = new ArrayList<>();
    ImageView backtovendor;
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backtovendor = findViewById(R.id.backtovendor);
        ...
        category_Recyclerview.setLayoutManager(new GridLayoutManager(BrandActivity.this, 1));
        ...
        backtovendor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(BrandActivity.this, CheckInActivity.class);
        ...
        try {
            ...
            if (response.isSuccessful()) {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Gson gson = new Gson();
                        Type userListType = new TypeToken<List<Brand>>() {
                        }.getType();

                        brandDetails = gson.fromJson(responseBody, userListType);
                        categoryListAdapter = new BrandAdapter(BrandActivity.this, brandDetails);
